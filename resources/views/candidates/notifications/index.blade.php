                    ...
                    @foreach ($notifications as $notification)
                        <div class="flex flex-col gap-3  w-full">
                            @if (isset($notification->data['etat']) && $notification->data['etat'] === 'accepter')
                                <div
                                    class="flex bg-white dark:bg-gray-900 items-center px-6 py-4 text-sm border-t-2  w-full rounded-b shadow-sm border-green-500">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-8 h-8 text-green-500 stroke-current" fill="none"
                                        viewBox="0 0 24 24">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <form action="{{ route('notifications.markAsRead', $notification->id) }}"
                                            ...
                                            <button type="submit" class="text-blue-500">Marquer comme lue   <i class="fa-solid fa-check-double"></i></button>
                                        </form>
                                        @else
                                        <i class=" text-blue-500 fa-solid fa-check-double"></i>
                            ...
                            @else
                                <div
                                    class="flex bg-white dark:bg-gray-900 items-center px-6 py-4 text-sm border-t-2 rounded-b shadow-sm border-yellow-300">
