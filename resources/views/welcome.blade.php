     ...
     <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex swiper-container">
          <div class="flex swiper-wrapper">
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 2" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 3" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 4" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 5" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 1" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 6" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 7" class="swiper-img"></div>
            <div class="swiper-slide max-h-40 h-3max-h-40"><img src="{{ asset('images/simplon.png') }}" alt="Partenaire 8" class="swiper-img"></div>
          </div>
          <!-- Add Pagination -->
