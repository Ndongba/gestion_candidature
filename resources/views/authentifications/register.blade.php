        ...
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                    ...
                    <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Se Connecter avec Google</h1>
                </a>
                ...
                <div class="mt-4">
                    ...
                    <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" placeholder="nom" name="nom" id="nom"/>
                </div>
                <div class="mt-4">
                    <div class="flex justify-between">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Prenom</label>
                    </div>
                    <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" placeholder="prenom" name="prenom" id="prenom"/>
                </div>
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" placeholder="telephone" name="telephone" id="telephone"/>
                </div>
