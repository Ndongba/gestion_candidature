                ...
                <div class="p-6">
                    <form id="inscriptionForm" action="{{route('register.save')}}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="telephone" placeholder="770000000" name="telephone" value="{{ old('telephone') }}" required>
                            @error('telephone')
                            <div class="text-red-500 text-sm mt-2">{{ $message }}</div>
                            @enderror
                        </div>
